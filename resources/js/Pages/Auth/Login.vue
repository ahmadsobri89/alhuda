    ...
    <div class="lr">
        ...
        <main class="lr-main">
            <div class="lr-card">
                ...
                <div class="lr-divider"><span>atau log masuk dengan</span></div>

                <a :href="route('auth.google')" class="lr-google-btn">
                    <svg class="lr-google-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="lr-divider lr-divider--sm"><span>Sistem akses terhad</span></div>
...
.lr-divider--sm { margin: 18px 0 14px; }
